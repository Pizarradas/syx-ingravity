...
```bash
npm install                # install dependencies (Sass + autoprefixer)
npm run build              # compile the ingravity theme
...
```bash
# Compile (uncompressed for development)
sass scss/styles-theme-ingravity.scss css/styles-theme-ingravity.css

# Compile (compressed for production)
sass scss/styles-theme-ingravity.scss css/styles-theme-ingravity.css --style=compressed --no-source-map
```

### With Watch Mode

```bash
sass --watch scss/styles-theme-ingravity.scss:css/styles-theme-ingravity.css
```
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/styles-theme-ingravity.css" />
  </head>
...
> **Note:** The INGRAVITY bundle (`styles-theme-ingravity.css`) is the single production bundle for this theme instance. See `blueprints/` for page-level HTML blueprints of the landing, PLP and checkout pages.
