...
- [ ] Compiles without errors (ingravity theme)
...
- [ ] `sass scss/styles-theme-ingravity.scss --style=compressed --no-source-map` compiles without errors
- [ ] The ingravity theme compiles without errors
